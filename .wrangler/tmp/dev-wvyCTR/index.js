...
// .wrangler/tmp/bundle-SsgeIM/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/bundle-SsgeIM/middleware-loader.entry.ts
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
// .wrangler/tmp/bundle-SsgeIM/middleware-insertion-facade.js
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_process();
init_virtual_unenv_global_polyfill_cloudflare_unenv_preset_node_console();
...
var MyMCP = class extends McpAgent {
  ...
  async _init(props) {
    ...
    const env2 = this.env;
    this.runwayApiKey = env2.RUNWAYML_API_KEY;
    console.log("=== MCP AGENT INIT ===");
    console.log("Environment available:", env2 ? "YES" : "NO");
  ...
  async init() {
    ...
    this.server.tool(
      "calculate",
      {
        operation: external_exports.enum(["add", "subtract", "multiply", "divide"]),
    ...
    this.server.tool(
      ...
      {
        prompt: external_exports.string().describe("Text prompt for video generation"),
        model: external_exports.enum(["gen4_turbo", "gen3a_turbo"]).default("gen4_turbo").describe("Model to use for generation"),
        duration: external_exports.number().min(5).max(10).default(5).describe("Video duration in seconds (5-10)"),
        ratio: external_exports.enum(["1280:720", "1920:1080", "720:1280", "1080:1920"]).default("1280:720").describe("Video aspect ratio"),
        auto_poll: external_exports.boolean().default(true).describe("Automatically poll until completion (default: true)"),
        max_wait_seconds: external_exports.number().default(300).describe("Maximum time to wait for completion in seconds (default: 300)")
      },
...
Prompt: "${prompt}"`;
                if (taskData.output) {
                  if (Array.isArray(taskData.output)) {
                    resultText += "\n\n\u{1F3AC} Generated Videos:";
                    taskData.output.forEach((url, index) => {
                      resultText += `
${index + 1}. ${url}`;
                    });
                  } else {
...
\u{1F3AC} Generated Video: ${taskData.output}`;
                  }
                }
                return {
                  content: [
...
Failure reason: ${taskData.failure || "Unknown error"}`
                ...
                return {
                  content: [
                    {
                      type: "text",
                      text: `\u{1F6AB} Text-to-video task was cancelled.
Task ID: ${taskData.id}`
                    }
                  ]
                };
...
Use runway_get_task to check manually.`
          ...
          return {
            content: [
              {
                type: "text",
                text: `Error creating text-to-video task: ${error3 instanceof Error ? error3.message : String(error3)}`
              }
            ]
          };
        }
    ...
    this.server.tool(
      ...
      {
        prompt_image: external_exports.string().describe("URL or base64 data URI of the input image"),
        prompt_text: external_exports.string().describe("Text prompt for video generation"),
        model: external_exports.enum(["gen4_turbo", "gen3a_turbo"]).default("gen4_turbo").describe("Model to use for generation"),
        duration: external_exports.number().min(5).max(10).default(5).describe("Video duration in seconds (5-10)"),
        ratio: external_exports.enum(["1280:720", "1920:1080", "720:1280", "1080:1920"]).default("1280:720").describe("Video aspect ratio"),
        auto_poll: external_exports.boolean().default(true).describe("Automatically poll until completion (default: true)"),
...
Failure reason: ${taskData.failure || "Unknown error"}`
                ...
                return {
                  content: [
                    {
                      type: "text",
                      text: `\u{1F6AB} Image-to-video task was cancelled.
Task ID: ${taskData.id}`
                    }
                  ]
                };
...
Use runway_get_task to check manually.`
          ...
          return {
            content: [
              {
                type: "text",
                text: `Error creating image-to-video task: ${error3 instanceof Error ? error3.message : String(error3)}`
              }
            ]
          };
        }
    ...
    this.server.tool(
      "runway_text_to_image",
      {
        ...
        ratio: external_exports.enum(["1920:1080", "1080:1920", "1280:720", "720:1280", "1024:1024"]).default("1920:1080").describe("Image aspect ratio"),
...
\u{1F5BC}\uFE0F Generated Image: ${taskData.output}`;
                  }
                }
                return {
                  content: [
...
Failure reason: ${taskData.failure || "Unknown error"}`
                ...
                return {
                  content: [
                    {
                      type: "text",
                      text: `\u{1F6AB} Text-to-image task was cancelled.
Task ID: ${taskData.id}`
                    }
                  ]
                };
...
Use runway_get_task to check manually.`
          ...
          return {
            content: [
              {
                type: "text",
                text: `Error creating text-to-image task: ${error3 instanceof Error ? error3.message : String(error3)}`
              }
            ]
          };
        }
    ...
    this.server.tool(
      "runway_get_task",
      {
        task_id: external_exports.string().describe("Task ID returned from a generation request")
      },
      async ({ task_id }) => {
        const actualApiKey = this.getApiKey();
        if (!actualApiKey) {
...
Failure reason: ${data.failure}`;
          ...
          return {
            content: [
              {
                type: "text",
                text: `Error retrieving task: ${error3 instanceof Error ? error3.message : String(error3)}`
              }
            ]
          };
        }
    ...
    this.server.tool(
      ...
      {
        task_id: external_exports.string().describe("Task ID returned from a generation request"),
        max_wait_seconds: external_exports.number().default(300).describe("Maximum time to wait in seconds (default: 300)")
      },
...
\u{1F5BC}\uFE0F Generated Content: ${data.output}`;
                }
              }
              return {
                content: [
...
Failure reason: ${data.failure || "Unknown error"}`
              ...
              return {
                content: [
                  {
                    type: "text",
                    text: `\u{1F6AB} Task was cancelled.
Task ID: ${data.id}`
                  }
                ]
              };
            ...
            return {
              content: [
                {
                  type: "text",
                  text: `Error polling task: ${error3 instanceof Error ? error3.message : String(error3)}`
                }
              ]
            };
          }
    ...
    this.server.tool(
      "runway_cancel_task",
      {
        task_id: external_exports.string().describe("Task ID to cancel")
      },
      async ({ task_id }) => {
        const actualApiKey = this.getApiKey();
        if (!actualApiKey) {
        ...
        try {
          ...
          return {
            content: [
              {
                type: "text",
                text: `Error cancelling task: ${error3 instanceof Error ? error3.message : String(error3)}`
              }
            ]
          };
        }
...
`;
          ...
          return {
            content: [
              {
                type: "text",
                text: `Error retrieving organization info: ${error3 instanceof Error ? error3.message : String(error3)}`
              }
            ]
          };
        }
...
var src_default = {
  fetch(request, env2, ctx) {
    ...
    console.log("RUNWAYML_API_KEY available:", env2.RUNWAYML_API_KEY ? "YES" : "NO");
    const url = new URL(request.url);
